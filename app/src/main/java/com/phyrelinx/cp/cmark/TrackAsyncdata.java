...
public class TrackAsyncdata extends AsyncTask<Void, Void, String> {
    ...
    public TrackAsyncdata( String url, String data, Activity activity, Context context, AsynTaskCallback asynTaskCallback) {
